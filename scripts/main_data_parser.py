...
def parse_log(
    ...
    Args:
        ...
        time_init (datetime.datetime): The start time of the time range.
        time_end (datetime.datetime): The end time of the time range.
...
def main():
    ...
    try:
        ...
        print(f"Datetime input format error: {ve}")
        sys.exit(1)
